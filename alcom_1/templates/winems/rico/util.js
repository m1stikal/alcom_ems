...
//ar:
function pullAttribute(theElement, theAttribute)
{
	var attrArray = theElement.attributes;
	var attrSize = attrArray.length;
	for (i=0;i<attrSize;i++)
	{
		var currAttr = attrArray[i];
		if ((currAttr.specified) && (currAttr.nodeName.toUpperCase() == theAttribute.toUpperCase()))
			return currAttr.nodeValue;
	}
	return null;
}